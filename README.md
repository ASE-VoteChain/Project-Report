...
| TF1     | 08/07/2025  | Sebastian Tasayco, Javier Martin                | Redacción del Sprint 2 |
| TF1     | 08/07/2025  | Ramirez Mendez, Sebastian Andre                | Redacción del Sprint 2 |
...
| **Criterio específico** | **Acciones realizadas** | **Conclusiones** |
|-------------------------|-------------------------|------------------|
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Ramirez Mendez, Sebastián Andre** <br> _TF1_ <br> Expuse el Capítulo VII, centrado en la validación técnica, funcional y de usuario de la solución VoteChain. Guié la presentación de resultados de pruebas, feedback de usuarios y criterios de mejora, utilizando un lenguaje claro y accesible para audiencias técnicas y de gestión. <br><br> **Ramos Ramirez, Renzo Manuel** <br> _TF1_ <br> Presenté los indicadores clave de rendimiento y métricas de uso extraídas del sistema, explicando su importancia para evaluar el impacto y la adopción del producto. Adapté el discurso para resaltar la utilidad tanto para equipos técnicos como para interesados estratégicos. <br><br> **Sebastian Tasayco, Javier Martin** <br> _TF1_ <br> Expliqué el proceso de despliegue y la gestión de entornos, haciendo énfasis en cómo se garantiza la disponibilidad y escalabilidad del sistema. Utilicé recursos visuales para asegurar una comprensión transversal del proceso. | _TF1_ <br> El equipo expuso con solidez los resultados finales del proyecto, articulando datos técnicos y métricas clave en un formato comprensible y persuasivo. Se demostró dominio del contenido, adaptación al público y claridad en la comunicación, consolidando la propuesta de valor del sistema desarrollado. |
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Ramirez Mendez, Sebastián Andre** <br> _TF1_ <br> Redacté el Capítulo VII, organizando los resultados de validación del sistema, pruebas realizadas, retroalimentación de usuarios y propuesta de mejora. Se utilizó una redacción estructurada y comprensible tanto para lectores técnicos como para stakeholders no técnicos. <br><br> **Ramos Ramirez, Renzo Manuel** <br> _TF1_ <br> Documenté las métricas e indicadores obtenidos en la etapa final del proyecto, explicando su relevancia en la medición de éxito y posibles mejoras del sistema. El lenguaje fue claro y enfocado en facilitar la toma de decisiones. <br><br> **Sebastian Tasayco, Javier Martin** <br> _TF1_ <br> Redacté la sección de despliegue del sistema, detallando los pasos para la publicación en producción, las herramientas utilizadas y las consideraciones para mantener la operación estable. | _TF1_ <br> La documentación final refleja un esfuerzo por comunicar con precisión y claridad los resultados obtenidos. El equipo logró articular los aspectos técnicos con una narrativa comprensible, permitiendo que diversos públicos comprendan el impacto y funcionamiento de la solución desarrollada. |
