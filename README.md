...
| TB2     | 20/06/2025  | Sebastian Tasayco, Javier Martin                | Revisión y redacción del apartado 7.1 (Software Configuration Management).                                                 |
| TB2     | 20/06/2025  | Bernardo Eusebio, Alessandro Joaquin            | Redacción del apartado 7.2.1.1 (Sprint Planning) y coordinación de tareas del Sprint Backlog.                              |
| TB2     | 20/06/2025  | Castillo Robles, Steve Roger                    | Documentación del apartado 7.2.1.6 (Evidencia de documentación de servicios del sprint).                                   |
| TB2     | 20/06/2025  | Ramos Ramirez, Renzo Manuel                     | Redacción del capítulo 6.4.3 (Mock-ups) y exposición de decisiones de diseño en el flujo de usuario.                       |
| TB2     | 20/06/2025  | Ramirez Mendez, Sebastian Andre                 | Redacción del análisis de entrevistas (2.2.3), desarrollo de gráficos y redacción de hallazgos e insights.                |
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.**    | **Ramirez Mendez, Sebastián Andre** <br> Presenté el análisis de entrevistas y validación de usuarios correspondiente al capítulo 2.2.3, desarrollando conclusiones visuales y gráficas, así como recomendaciones que fueron comunicadas claramente en una exposición dirigida a miembros técnicos y no técnicos. <br><br> **Ramos Ramirez, Renzo Manuel** <br> Expliqué el diseño de mock-ups y arquitectura de interacción descritos en el capítulo 6.4.3, fundamentando cómo la propuesta mejora la experiencia del usuario en cada flujo mostrado. <br><br> **Sebastian Tasayco, Javier Martin** <br> Expliqué el apartado 7.1 del Capítulo VII, detallando el software configuration management, sus criterios y especificaciones conforme a las guías de configuración por cada tecnología aplicada. <br><br> **Bernardo Eusebio, Alessandro Joaquin** <br> Expliqué la planificación del Sprint (7.2.1.1), mostrando cómo se derivaron las tareas del Product Backlog, organizando los entregables colaborativos y facilitando el seguimiento de responsabilidades en el repositorio. <br><br> **Castillo Robles, Steve Roger** <br> Presenté el subcapítulo 7.2.1.6 sobre documentación técnica del sprint, explicando cómo se registró cada evidencia del servicio implementado, orientado a facilitar futuras integraciones técnicas en el proyecto. | El equipo demostró una comunicación efectiva de los avances del proyecto, con exposiciones claras, estructuradas y dirigidas a una audiencia diversa. Se adaptó el lenguaje según el perfil técnico o de gestión, utilizando recursos visuales y ejemplos funcionales. Cada integrante explicó con dominio su parte, asegurando comprensión y coherencia en el mensaje. |
| **Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.** | **Ramirez Mendez, Sebastián Andre** <br> Redacté la sección 2.2.3 del Capítulo II, elaborando un análisis estadístico completo de las entrevistas, con tablas y visualizaciones claras que facilitaron la interpretación por parte de equipos técnicos, de diseño y gestión. <br><br> **Ramos Ramirez, Renzo Manuel** <br> Documenté parte del capítulo 6.4.3, incluyendo los mock-ups de la aplicación con sus respectivas descripciones funcionales, justificando las decisiones visuales y de navegación según criterios de UX. <br><br> **Sebastian Tasayco, Javier Martin** <br> Redacté el apartado 7.1 del Capítulo VII, describiendo el proceso de configuración de entorno de desarrollo, dependencias y estilo de código en las tecnologías aplicadas. <br><br> **Bernardo Eusebio, Alessandro Joaquin** <br> Documenté el Sprint Planning (7.2.1.1) y la organización del Sprint Backlog (7.2.1.2), describiendo con claridad la priorización de historias, la estructura de asignación y los procesos de colaboración usados en GitHub. <br><br> **Castillo Robles, Steve Roger** <br> Redacté el apartado 7.2.1.6 del Capítulo VII sobre documentación de servicios, detallando el registro de configuraciones técnicas, archivos relevantes y evidencias generadas en el sprint. | La documentación escrita fue clara, coherente y adaptada a distintos niveles de especialidad. Se empleó una estructura formal, tablas, capturas y justificaciones técnicas que facilitaron la lectura para desarrolladores, docentes y stakeholders no técnicos. El equipo evidenció dominio en redacción técnica alineada a objetivos de ingeniería.             |
